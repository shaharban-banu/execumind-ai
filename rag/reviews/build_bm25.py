"""
Build BM25 index for review chunks.
This module:
1. Loads review chunks.
2. Tokenizes review texts.
3. Builds BM25 index.
"""
...
INDEX_PATH=INDEX_DIR/"reviews_bm25_index.pkl"

def load_chunks():
    """
    Load review chunks.
    """
    logger.info("Loading review chunks..")
